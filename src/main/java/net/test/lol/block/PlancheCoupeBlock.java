...
public class PlancheCoupeBlock extends Test1ModElements.ModElement {

	@ObjectHolder("test1:planche_coupe")
	public static final Block block = null;

	@ObjectHolder("test1:planche_coupe")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public PlancheCoupeBlock(Test1ModElements instance) {
		super(instance, 3);
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("planche_coupe");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Planche Coupe");
		}
